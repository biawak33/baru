...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${text}?apikey=sanzyyt`)
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/stalktiktok/${text}?apikey=sanzyyt`)
...
if (!text) throw `Kirim perintah ${prefix + command} *username*\n\nExample : ${prefix + command} Jokowi`
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/twitter/${text}?apikey=sanzyyt`)
...
mee = await hisoka.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.lolhuman.xyz/api/editor/${command}?apikey=sanzyyt&img=${mem}`
memek = await hisoka.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
break
...
mee = await hisoka.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.lolhuman.xyz/api/filter/${command}?apikey=sanzyyt&img=${mem}`
memek = await hisoka.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
break
...
mee = await hisoka.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.lolhuman.xyz/api/creator1/${command}?apikey=sanzyyt&img=${mem}`
memek = await hisoka.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(memek)
}
break
...
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/sticker/${command}?apikey=sanzyyt`)
...
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=sanzyyt&name=${text}`) 
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
...
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/pacarserti?apikey=sanzyyt&name1=${text}&name2=${text}`) 
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
	    case 'couple': {
...
if (!text) throw `Example : ${prefix + command} SanzyYT`
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=sanzyyt&text=${text}`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
case '1917': 
...
if (!text) throw `Example : ${prefix + command} SanzyYT`
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=sanzyyt&text=${text}`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
...
if (!text) throw `Example : ${prefix + command} SanzyYT`
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/ephoto2/codwarzone?apikey=sanzyyt&text1=${text}&text2=${text}`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: ftroli})
}
break
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/mediafire?apikey=sanzyyt&url=${text}`)
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/groupwhatsapp?apikey=sanzyyt&query=${text}`)
...
m.reply(mess.wait)
let anu = await fetchJson(`https://api.lolhuman.xyz/api/sholat/pekanbaru?apikey=sanzyyt`)
...
case 'audio1': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/1?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio2': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/2?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio3': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/3?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio4': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/4?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio5': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/5?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio6': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/6?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio7': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/7?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio8': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/8?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio9': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/9?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'audio10': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/10?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { audio: anu, mimetype: 'audio/mpeg'}, { quoted: m })
}
break
case 'anime': case 'waifu': case 'husbu': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': {
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapis.xyz/api/random/${command}?apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
...
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapis.xyz/api/image/phcomment?image=https://i.ibb.co/KjSBWx4/Pics-Art-02-07-11-45-03.jpg&text=${text}&username=SanzyYT&apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
case 'ytcomment': {
if (!text) throw `Example : ${prefix + command} Keren Sih`
m.reply(mess.wait)
let anu = await getBuffer(`https://zenzapis.xyz/api/image/ytcomment?image=https://i.ibb.co/KjSBWx4/Pics-Art-02-07-11-45-03.jpg&text=${text}&username=SanzyYT&apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
case 'kannagen': {
if (!text) throw `Exampel : ${prefix + command} SanzyYT`
let anu = await getBuffer (`https://zenzapis.xyz/api/image/kannagen?text=${text}&apikey=sanzyyt`)
hisoka.sendMessage(m.chat, { image: anu, caption: `Nih  Kak` }, { quoted: m})
}
break
case 'asupan': {
m.reply(mess.wait)
let anu = await getBuffer(`https://api.lolhuman.xyz/api/asupan?apikey=sanzyyt`)
...
case 'sewa': case 'sewabot': {
                anu = `HARGA SEWA BOT ALRETH STORE !!
PERMANENT 8K / GRUP

NOTE : SAYA TIDAK MENJAMIN KAPAN KAMI PENSI MENJADI BOT ENTAH LAMA / CEPATNYA KAMU TIDAK BISA MENENTUKAN NYA SEMOGA AJA LAMA !! Terimakasih yang telah order dan jangan lupa masuk ke grup kami !! 
👇🏻
Grup bot !?👇🏻
https://chat.whatsapp.com/KherOXdL3qA2QroTeFT2rU

Grup ALRETH STORE!?👇🏻
https://chat.whatsapp.com/HyLEeaIeBNt2wZOZNeXfWe`
                let button = [{
                                quickReplyButton: {
