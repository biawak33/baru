...
async function startHisoka() {
   ...
   hisoka.ws.on('CB:call', async (json) => {
    ...
    hisoka.ev.on(`CB:battery`, json => {
    hisoka.sendText(owner[1]+'@s.whatsapp.net', json)
    })
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppgroup = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
                       ...
                       let Ttes = `Yah Kok Keluar Dari *${metadata.subject}*, Sayonara @${num.split("@")[0]} :(`
                ...
                const template = generateWAMessageFromContent(anu.id, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: 'Welcome Message Sanzy YT',
                            hydratedButtons: [{
                                urlButton: {
                ...
                const template = generateWAMessageFromContent(anu.id, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: 'Leaving Message By Sanzy YT',
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Youtube Creator',
                                    url: 'https://youtube.com/c/SanzyYT'
...
hisoka.sendFileUrl = async (jid, url, caption, quoted, men, options = {}) => {
...
return hisoka.sendMessage(jid, { video: await getBuffer(url), caption: caption, gifPlayback: true, mentions: men ? men : [], ...options}, { quoted: quoted, ...options})
...
return hisoka.sendMessage(jid, { document: await getBuffer(url), mimetype: 'application/pdf', caption: caption, mentions: men ? men : [], ...options}, { quoted: quoted, ...options })

 }

 if(mime.split("/")[0] === "image"){

return hisoka.sendMessage(jid, { image: await getBuffer(url), caption: caption, mentions: men ? men : [], ...options}, { quoted: quoted, ...options})

 }

 if(mime.split("/")[0] === "video"){

return hisoka.sendMessage(jid, { video: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'video/mp4', ...options}, { quoted: quoted, ...options })

 }

 if(mime.split("/")[0] === "audio"){

return hisoka.sendMessage(jid, { audio: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'audio/mpeg', ...options}, { quoted: quoted, ...options })
